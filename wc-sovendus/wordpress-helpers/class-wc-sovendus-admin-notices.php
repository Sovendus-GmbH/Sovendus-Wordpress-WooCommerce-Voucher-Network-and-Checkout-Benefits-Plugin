...
class WC_Sovendus_Admin_Notices
{
    ...
    {
        echo '<div class="notice notice-error">';
        echo '<p>' . wp_kses_post(__('Sovendus App for WooCommerce requires active WooCommerce Installation on the network, please install and activate WooCommerce plugin network-wide!', 'wc-sovendus')) . '</p>';
        echo '</div>';
    }
}